...
def collapse(layout, key):
    ...
    return sg.pin(sg.Column(layout, key=key))
     ...
     # [sg.Frame(layout=[
     #    [sg.Text('Individual (unstacked) files). Stacked > 50MB will be ignored',background_color='DodgerBlue3'),
     #        sg.T('* ',size=(3,1),font=('Helvetica',12),text_color='red',background_color='DodgerBlue4',pad=(0,0))],
     #        [sg.InputText(key='-FILE_LOCATION-'),sg.FolderBrowse(target='-FILE_LOCATION-')]

     #    ],title='Child Tif Folder Location',title_color='orange',relief=sg.RELIEF_SUNKEN,background_color='DodgerBlue4'), #, enable_events=True
     #     ],


section1 = [[sg.Frame(layout=[
