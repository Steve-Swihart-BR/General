# -*- coding: utf-8 -*-
"""
Created on Thu Oct  1 21:44:53 2020
...
def collapsibleSection(layout, key, initially_visible):
    """
    ...
    :rtype: sg.pin
    """
    return sg.pin(sg.Column(layout, key=key, visible=initially_visible))

# Need to complete the metadata=initially_visible part of this: https://github.com/PySimpleGUI/PySimpleGUI/issues/4129
...
layout =   [[sg.Text('Window with 2 collapsible sections')],
            ...
            [collapsibleSection(section1, '-SEC1-', initially_visible=True)],
            #### Section 2 part ####
            ...
            [collapsibleSection(section2, '-SEC2-', initially_visible=False)],
            #### Buttons at bottom ####
...
# Do the following 2 lines to have Sec 1 appear in closed state on open
#opened1=False
#window['-OPEN SEC1-'].update(SYMBOL_UP)
